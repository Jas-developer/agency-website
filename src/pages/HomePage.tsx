    ...
    <main className=" lg:mt-[2rem] relative font-serif ">
      <section className="grid  lg:grid-cols-2   lg:pb-[4rem] items-center md:px-12 lg:px-24 px-2">
        <div className="px-2">
          ...
          <div className=" text-gray-100 lg:p-4 p-2">
            ...
            <span
              className="lg:text-3xl md:text-2xl lg:text-start text-xl text-gray-100 flex justify-center lg:justify-start
          
          font-semibold"
            >
              PROVIDE SOFTWARE SOLUTIONS FOR YOUR BUSINESS
            </span>
            <div className="prose prose-md md:prose-lg items-center  text-gray-100 lg:text-start lg:prose-2xl mt-5 lg:mt-12">
              <p className="strong">
      ...
      <section className="bg-gray-800  lg:px-24 px-2 lg:py-24 z-10">
